        ...
        <StyledProjects>
            <Container>
                ...
                <FlexWrapper direction={'column'} align={'center'} justify={'space-between'} gap={'78px'}>
                    ...
                    <Project name={'Project Name'} text={'What was your role, your deliverables, if the project was personal, freelancing.'} src={marker} button={'View Project'}/>
                    <Project name={'Project Name'} text={'You can also add in this description the type of the project, if it was for web, mobile, electron.'} src={tel} button={'View Project'}/>
                </FlexWrapper>
